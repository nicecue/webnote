      ...
      <div style={editContainerStyle}>
        <div className="input-group">
          <div className="input-group-btn">
            <span 
              className="btn btn-primary"data-toggle="dropdown"
              style={{ fontSize: '18px' }}>
              제목
            </span>
          </div>
          <input type="text" className="form-control" value={title}
            ref={r => this.titleInput = r} onChange={this.onChangeTitle} style={inputStyle} />
        </div>
        <textarea className="form-control" value={contents} onChange={this.onChangeContents}
          style={textareaStyle} ref={r => this.contentsInput = r} />
        <div style={buttonBoxStyle} className="col-md-12">
          ...
          <div className="col-xs-6" style={{ padding: '0' }}>
            <button onClick={this.onBtnCancel} 
              className="btn btn-block btn-default btn-lg">취소</button>
          </div>
